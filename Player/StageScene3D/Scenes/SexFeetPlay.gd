...
func playAnimation(animID, _args = {}):
	...
	if(animID == "pin"):
		state_machine.travel("Sex_FootPin_1-loop")
		state_machine2.travel("Sex_FootPin_2-loop")
	if(animID == "head"):
		state_machine.travel("Sex_FootHeadPin_1-loop")
		state_machine2.travel("Sex_FootHeadPin_2-loop")
	if(animID == "crotch"):
		state_machine.travel("Sex_FootCrotch_1-loop")
		state_machine2.travel("Sex_FootCrotch_2-loop")
