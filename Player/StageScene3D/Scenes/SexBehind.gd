...
func playAnimation(animID, _args = {}):
	...
	if(animID == "tease"):
		state_machine.travel("SexBehindTease_1-loop")
		state_machine2.travel("SexBehindTease_2-loop")
	if(animID == "inside"):
		state_machine.travel("SexBehindInside_1-loop")
		state_machine2.travel("SexBehindInside_2-loop")
	if(animID == "sex"):
		state_machine.travel("SexBehind_1-loop")
		state_machine2.travel("SexBehind_2-loop")
	if(animID == "fast"):
		state_machine.travel("SexBehindFast_1-loop")
		state_machine2.travel("SexBehindFast_2-loop")
