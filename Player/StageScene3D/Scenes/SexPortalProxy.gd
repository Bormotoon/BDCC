...
func playAnimation(animID, _args = {}):
	...
	doll.attachTemporaryUnriggedPart("hand.R", "res://Inventory/UnriggedModels/Fleshlight/FleshlightAlt3.tscn")
	...
	#doll3.visible = false
	if(animID == "tease"):
		state_machine.travel("PortalSexProxyTease_1-loop")
		state_machine2.travel("PortalSexTease_2-loop")
		state_machine3.travel("PortalSexProxyTease_3-loop")
	if(animID == "inside"):
		state_machine.travel("PortalSexProxyInside_1-loop")
		state_machine2.travel("PortalSexInside_2-loop")
		state_machine3.travel("PortalSexProxyInside_3-loop")
	if(animID == "sex"):
		state_machine.travel("PortalSexProxy_1-loop")
		state_machine2.travel("PortalSexSquirm_2-loop")
		state_machine3.travel("PortalSexProxy_3-loop")
	if(animID == "fast"):
		state_machine.travel("PortalSexProxyFast_1-loop")
		state_machine2.travel("PortalSexSquirmFast_2-loop")
		state_machine3.travel("PortalSexProxyFast_3-loop")
