...
func playAnimation(animID, _args = {}):
	...
	if(animID == "tease"):
		state_machine.travel("Sex_HandjobTease_1-loop")
		state_machine2.travel("Sex_HandjobTease_2-loop")
		doll2.setTemporaryState("hands", "fists")
	if(animID == "sex"):
		state_machine.travel("Sex_Handjob_1-loop")
		state_machine2.travel("Sex_Handjob_2-loop")
		doll2.setTemporaryState("hands", "fists")
	if(animID == "fast"):
		state_machine.travel("Sex_HandjobFast_1-loop")
		state_machine2.travel("Sex_HandjobFast_2-loop")
		doll2.setTemporaryState("hands", "fists")
