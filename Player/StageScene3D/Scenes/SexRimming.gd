...
func playAnimation(animID, _args = {}):
	...
	if(animID == "tease"):
		state_machine.travel("SexRimTease_1-loop")
		state_machine2.travel("SexRimTease_2-loop")
	if(animID == "sex"):
		state_machine.travel("SexRim_1-loop")
		state_machine2.travel("SexRim_2-loop")
	if(animID == "fast"):
		state_machine.travel("SexRimFast_1-loop")
		state_machine2.travel("SexRimFast_2-loop")
