...
func _init():
	id = StageScene.PuppySexAllFours
...
func playAnimation(animID, _args = {}):
	...
	if(animID == "tease"):
		state_machine.travel("PuppySexTease_1-loop")
		state_machine2.travel("PuppySexTease_2-loop")
	if(animID == "inside"):
		state_machine.travel("PuppySexInside_1-loop")
		state_machine2.travel("PuppySexInside_2-loop")
	if(animID == "sex"):
		state_machine.travel("PuppySex_1-loop")
		state_machine2.travel("PuppySex_2-loop")
	if(animID == "fast"):
		state_machine.travel("PuppySexFast_1-loop")
		state_machine2.travel("PuppySexFast_2-loop")
