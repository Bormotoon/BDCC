...
func playAnimation(animID, _args = {}):
	...
	if(animID == "tease"):
		state_machine.travel("SpankingTease_1-loop")
		state_machine2.travel("SpankingTease_2-loop")
	if(animID == "spank"):
		state_machine.travel("Spanking_1-loop")
		state_machine2.travel("Spanking_2-loop")
	if(animID == "fast"):
