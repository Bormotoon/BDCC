...
func playAnimation(animID, _args = {}):
	...
	#doll3.visible = false
	if(animID == "tease"):
		state_machine.travel("PortalSexRideTease_1-loop")
		state_machine2.travel("PortalSexTease_2-loop")
		state_machine3.travel("PortalSexRideTease_3-loop")
	if(animID == "inside"):
		state_machine.travel("PortalSexRideInside_1-loop")
		state_machine2.travel("PortalSexInside_2-loop")
		state_machine3.travel("PortalSexRideInside_3-loop")
	if(animID == "sex"):
		state_machine.travel("PortalSexRide_1-loop")
		state_machine2.travel("PortalSexSquirm_2-loop")
		state_machine3.travel("PortalSexRide_3-loop")
	if(animID == "fast"):
		state_machine.travel("PortalSexRideFast_1-loop")
		state_machine2.travel("PortalSexSquirmFast_2-loop")
		state_machine3.travel("PortalSexRideFast_3-loop")
