...
func _init():
	id = StageScene.SexReverseCowgirl
...
func playAnimation(animID, _args = {}):
	...
	if(animID == "tease"):
		state_machine.travel("Sex_ReverseCowgirlTease_1-loop")
		state_machine2.travel("Sex_ReverseCowgirlTease_2-loop")
	if(animID == "inside"):
		state_machine.travel("Sex_ReverseCowgirlInside_1-loop")
		state_machine2.travel("Sex_ReverseCowgirlInside_2-loop")
	if(animID == "sex"):
		state_machine.travel("Sex_ReverseCowgirl_1-loop")
		state_machine2.travel("Sex_ReverseCowgirl_2-loop")
	if(animID == "fast"):
		state_machine.travel("Sex_ReverseCowgirlFast_1-loop")
		state_machine2.travel("Sex_ReverseCowgirlFast_2-loop")
