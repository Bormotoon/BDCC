...
func playAnimation(animID, _args = {}):
	...
	if(animID == "tease"):
		state_machine.travel("SexStandRideTease_1-loop")
		state_machine2.travel("SexStandRideTease_2-loop")
	if(animID == "inside"):
		state_machine.travel("SexStandRideInside_1-loop")
		state_machine2.travel("SexStandRideInside_2-loop")
	if(animID == "sex"):
		state_machine.travel("SexStandRide_1-loop")
		state_machine2.travel("SexStandRide_2-loop")
	if(animID == "fast"):
