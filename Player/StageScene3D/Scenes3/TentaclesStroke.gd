...
func playAnimation(animID, _args = {}):
	...
	if(animID == "tease"):
		state_machine.travel("TentStrokeTease_1-loop")
		state_machine2.travel("TentStrokeTease_2-loop")
	elif(animID == "stroke"):
		state_machine.travel("TentStroke_1-loop")
		state_machine2.travel("TentStroke_2-loop")
	elif(animID == "fast"):
		state_machine.travel("TentStrokeFast_1-loop")
		state_machine2.travel("TentStrokeFast_2-loop")
