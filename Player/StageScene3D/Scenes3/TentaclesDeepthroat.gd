...
func _init():
	id = StageScene.TentaclesDeepthroat
...
func playAnimation(animID, _args = {}):
	...
	if(animID == "tease"):
		state_machine.travel("TentDeepTease_1-loop")
		state_machine2.travel("TentDeepTease_2-loop")
	elif(animID == "inside"):
		state_machine.travel("TentDeepInside_1-loop")
		state_machine2.travel("TentDeepInside_2-loop")
	elif(animID == "sex"):
		state_machine.travel("TentDeep_1-loop")
		state_machine2.travel("TentDeep_2-loop")
	elif(animID == "fast"):
		state_machine.travel("TentDeepFast_1-loop")
		state_machine2.travel("TentDeepFast_2-loop")
