...
func _init():
	id = StageScene.TentaclesGangbang
...
func playAnimation(animID, _args = {}):
	...
	if(animID == "tease"):
		state_machine.travel("TentGangTease_1-loop")
		state_machine2.travel("TentGangTease_2-loop")
	if(animID == "teasedef"):
		state_machine.travel("TentGangTeaseDef_1-loop")
		state_machine2.travel("TentGangTeaseDef_2-loop")
	if(animID == "inside"):
		state_machine.travel("TentGangInside_1-loop")
		state_machine2.travel("TentGangInside_2-loop")
	elif(animID == "stroke"):
		state_machine.travel("TentGang_1-loop")
		state_machine2.travel("TentGang_2-loop")
	elif(animID == "fast"):
		state_machine.travel("TentGangFast_1-loop")
		state_machine2.travel("TentGangFast_2-loop")
...
func getSupportedStates():
	return ["tease", "teasedef", "inside", "stroke", "fast"]
