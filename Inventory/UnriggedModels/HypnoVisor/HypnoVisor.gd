...
func randomColorTween():
	tweenModuleTo($Lines1, Color.from_hsv(randf_range(0.0, 1.0), 1.0, 1.0), randf_range(0.5, 1.5), tween1, "randomColorTween")
func randomColorTween2():
	tweenModuleTo($Lines2, Color.from_hsv(randf_range(0.0, 1.0), 1.0, 1.0), randf_range(0.5, 1.5), tween2, "randomColorTween2")
