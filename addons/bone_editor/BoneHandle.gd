...
func _ready( ):
	...
	if parent_bone_id != -1:
		...
		#global_transform = skeleton.get_bone_global_pose( bone_id )
...
func init_pose( ):
	...
	#self.skeleton.set_bone_pose( self.bone_id, Transform(Basis(Vector3(1.0,0.0,0.0))) )
...
func _process( delta:float ):
	...
	if self.enabled:
		#skeleton.set_bone_pose( self.bone_id, transform )
		#if(true):
		#	return
